...
export const DisplayProfessorConflicts: FC<{
  professorConflicts: ConflictInfo[]
  targetProfessor: string
}> = ({ professorConflicts, targetProfessor }) => {
        ...
        <div className="space-y-2">
          <div>
            <div
              ...
              onClick={() => handleProfessorClick(targetProfessor)}
            >
              {targetProfessor}
            </div>
